...
A testcoind binary is not included in the testcoin-Qt.app bundle. You can ignore
this section if you are building `testcoind` for your own use.
...
on an OS X 10.6 64-bit machine fails. Official release builds of testcoin-Qt are
compiled on an OS X 10.6 32-bit machine to workaround that problem.

Once dependencies are compiled, creating `testcoin-Qt.app` is easy:
