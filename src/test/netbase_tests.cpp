...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:1987", "127.0.0.1", 1987));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1987", "127.0.0.1", 1987));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1987", "::ffff:127.0.0.1", 1987));
    BOOST_CHECK(TestSplitHost("[::]:1987", "::", 1987));
    BOOST_CHECK(TestSplitHost("::1987", "::1987", -1));
    BOOST_CHECK(TestSplitHost(":1987", "", 1987));
    BOOST_CHECK(TestSplitHost("[]:1987", "", 1987));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1987", "127.0.0.1:1987"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:1111"));
    BOOST_CHECK(TestParse("::", "[::]:1111"));
    BOOST_CHECK(TestParse("[::]:1987", "[::]:1987"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:1111"));
